...
; This is the new code from the japanese version backported to MF_E.
; By SpineShark
.gba
.open "MF_E.gba","MF_E_PressStartToSkipIntro.gba",0x8000000

.definelabel FreeSpace, filesize("MF_E.gba") + 0x8000000
...
.org 0x80877CE ; In NewFileIntroSubroutine
    mov     pc,r0
...
;    beq     @@_808866E         ;/
    ...
    strh    r0,[r2]
@@_808866E:
    ldr     r3,=0x80877D0 ; return address
    mov     pc,r3
    .pool
